...
public class OrderBean_2 implements Writable, WritableComparable<OrderBean_2> {
    ...
    public int compareTo(OrderBean_2 o) {
        //先比总金额，在比商品名
        return this.orderId.compareTo(o.getOrderId())==0?
                Float.compare(o.getAmountFee(),this.amountFee):
